...
[Command]
name = "ã‹Öç“ó•SEˆë®E”ª’t—"
command = ~D, DF, F, DF, D, DB, B, x
time = 20
buffer.time = 6

[Command]
name = "‹­‹Öç“ó•SEˆë®E”ª’t—"
...
;-| “¯‰Ÿ‚µ |-----------------------------------------------------------------
[Command]
name = "recovery"   ;—v‹Ï‚İ (ƒL‚Ì•ÏX‚Í‰Â‚Å‚·‚ª–¼‘O‚ğ•Ï‚¦‚½‚è–³Œø‚É‚µ‚Ä‚Í‚¢‚¯‚Ü‚¹‚ñ)
command = x+a
time = 1
buffer.time = 6
...
;-| •ûŒüƒL‰Ÿ‚µ‚Á‚Ï‚È‚µ |-----------------------------------------------------
[Command]
name = "holdfwd"   ;—v‹Ï‚İ (ƒL‚Ì•ÏX‚Í‰Â‚Å‚·‚ª–¼‘O‚ğ•Ï‚¦‚½‚è–³Œø‚É‚µ‚Ä‚Í‚¢‚¯‚Ü‚¹‚ñ)
command = /$F
time = 1

[Command]
name = "holdback"  ;—v‹Ï‚İ (ƒL‚Ì•ÏX‚Í‰Â‚Å‚·‚ª–¼‘O‚ğ•Ï‚¦‚½‚è–³Œø‚É‚µ‚Ä‚Í‚¢‚¯‚Ü‚¹‚ñ)
command = /$B
time = 1

[Command]
name = "holdup"    ;—v‹Ï‚İ (ƒL‚Ì•ÏX‚Í‰Â‚Å‚·‚ª–¼‘O‚ğ•Ï‚¦‚½‚è–³Œø‚É‚µ‚Ä‚Í‚¢‚¯‚Ü‚¹‚ñ)
command = /$U
time = 1

[Command]
name = "holddown"  ;—v‹Ï‚İ (ƒL‚Ì•ÏX‚Í‰Â‚Å‚·‚ª–¼‘O‚ğ•Ï‚¦‚½‚è–³Œø‚É‚µ‚Ä‚Í‚¢‚¯‚Ü‚¹‚ñ)
command = /$D
time = 1
...
type = ChangeState
value = 2050
triggerall = command = "‹­‹Öç“ó•SEˆë®E”ª’t—"
triggerall = power >= 1000
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = stateno = 210 && movecontact
...
type = ChangeState
value = 2000
triggerall = command = "ã‹Öç“ó•SEˆë®E”ª’t—"
triggerall = power >= 1000
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = stateno = 210 && movecontact
...
type = ChangeState
value = 1800
triggerall = command = "ã“ólE“ó®E‹ÕŒ"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = stateno = 210
trigger3 = stateno = 215 && movecontact && time = [0,13]
...
type = ChangeState
value = 1850
triggerall = command = "‹­“ólE“ó®E‹ÕŒ"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = stateno = 210
trigger3 = stateno = 215 && movecontact && time = [0,13]
...
type = ChangeState
value = 1450
triggerall = command = "‹­Q•SEˆë®E’Ü‹ù"
triggerall = statetype != A
trigger1 = ctrl
...
type = ChangeState
value = 1400
triggerall = command = "ãQ•SEˆë®E’Ü‹ù"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = stateno = 200 && movecontact
trigger3 = stateno = 205 && movecontact
...
type = ChangeState
value = 1200
triggerall = command = "ã•S“óEµ®Eˆ¨‰Ô"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = stateno = 210
trigger3 = stateno = 215 && movecontact && time = [0,13]
...
type = ChangeState
value = 1250
triggerall = command = "‹­•S“óEµ®Eˆ¨‰Ô"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = stateno = 210
trigger3 = stateno = 215 && movecontact && time = [0,13]
...
value = 600
triggerall = command = "x"
triggerall = stateno != 105  ;ƒoƒbƒNƒXƒeƒbƒv’†‚Í‹Ö
trigger1 = statetype = A
trigger1 = ctrl
triggerall = var(50) = 0
...
[State AI]
type = ChangeState
value = ifelse((random%2),2800,3100)
triggerall = var(50) != 0
triggerall = power >= 2000
triggerall = random <= 100*AiLevel
...
[State AI]
type = ChangeState
value = ifelse((random%2),2800,2050)
triggerall = var(50) != 0
triggerall = power >= 2000
triggerall = p2statetype = A
triggerall = movehit
...
[State AI]
type = ChangeState
value = ifelse((random%2=0),2800,2050)
triggerall = var(50) != 0
triggerall = random <= 100*AiLevel
triggerall = roundstate = 2
triggerall = power >= 2000
...
type = ChangeState
value = 1500
triggerall = Enemynear,name = "kusanagi"
triggerall = var(50) != 0
triggerall = RoundState = 2
...
trigger1 = (p2bodydist x = [5,15]) && random <= 100*AiLevel
trigger1 = statetype != A && ctrl
trigger2 = (p2bodydist x = [0,18]) && random <= 100*AiLevel && movecontact
...
triggerall = random <= 100*AiLevel && p2statetype != L
...
[State AI]
type = ChangeState
value = ifelse((random%2=0),1850,1350)
triggerall = var(50) != 0
triggerall = power >= 1000
triggerall = p2statetype != A
triggerall = movehit
...
[State AI]
type = ChangeState
value = ifelse((random%2=0),2400,2050)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 100*AiLevel
...
triggerall = movehit
triggerall = power >= 2000
trigger1 = stateno = 1370
trigger1 = time = 46
triggerall = enemy,var(46) = 0

[State AI]
type = ChangeState
value = ifelse((random%2=0),3100,2050)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 100*AiLevel
triggerall = movehit
...
[State AI]
type = ChangeState
value = ifelse((random%2=0),ifelse((teammode=simul),1750,1250),2050)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 100*AiLevel
triggerall = movehit
...
[State AI]
type = null;ChangeState
value = ifelse((teammode=simul),1750,1250)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 999
triggerall = movehit
...
[State AI]
type = ChangeState
value = ifelse((random%2=0),100,210)
triggerall = var(50) != 0
triggerall = random <= 100*AiLevel
triggerall = p2stateno = 1520
triggerall = ctrl&& statetype != A
