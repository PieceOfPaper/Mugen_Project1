...
trigger4 = Enemynear,name = "Orochi Kyo"
trigger5 = Enemynear,name = "Kyo Kusanagi"
v = 51
value = 1
ignorehitpause = 1
persistent = 1
...
value = 1650
triggerall = var(50) != 0
triggerall = Enemy,name != "Athena Asamiya"
triggerall = Enemy,name != "Adelheid_XI"
...
[State AI]
type = ChangeState
value = ifelse((random<=800),ifelse((random<=500),1750,1250),2050)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 999
triggerall = movehit
...
[State AI]
type = ChangeState
value = ifelse((random<=500),1750,1250)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 999
triggerall = movehit
...
[State AI]
type = ChangeState
value = ifelse((random<=400),2800,2050)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 999
triggerall = movehit
